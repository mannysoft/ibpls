<form id="myform" method="post" action="" target="" enctype="multipart/form-data">
  <table width="100%" border="0" class="type-one">
      ...
      <tr>
        ...
        <td width="75%" bgcolor="#ffffff"><?php echo form_dropdown('tax_fee_type_id', $tax_fee_type_id_options, 'large');?></td>
      </tr>
      <tr>
        <td align="right" bgcolor="#ffffff">Amount:</td>
        <td bgcolor="#ffffff"><input name="amount" type="text" id="amount" value="<?php echo set_value('amount', '0.00'); ?>" /></td>
      </tr>
      <tr>
        <td align="right" bgcolor="#ffffff"><label for="amount">No. of Years:</label></td>
        <td bgcolor="#ffffff"><input name="number_years" type="text" id="number_years" value="<?php echo set_value('number_years', 0); ?>" /> 
          (0 - 100)</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td><input name="set_default" type="checkbox" id="set_default" value="1" />
