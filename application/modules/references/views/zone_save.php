<form id="myform" method="post" action="" target="" enctype="multipart/form-data">
  <table width="100%" border="0" class="type-one">
      ...
      <tr>
        ...
        <td bgcolor="#ffffff"><?php echo form_dropdown('barangay_id', $barangay_options, $zone->barangay_id);?></td>
      </tr>
      <tr>
        <td align="right" bgcolor="#ffffff"><label for="name">Zone Name:</label></td>
        <td bgcolor="#ffffff"><input name="name" type="text" id="name" value="<?php echo set_value('name', $zone->name); ?>" /></td>
      </tr>
      <tr>
